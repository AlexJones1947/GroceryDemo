...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    public final int CURVE_EDGE_RADIUS = 128 / 3;
    // the coordinates of the first curve
    public Point mAFirstCurveControlPoint1 = new Point();
    public Point mAFirstCurveControlPoint2 = new Point();
    public Point mAFirstCurveEndPoint = new Point();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mAFirstCurveControlPoint1.set(10 + CURVE_EDGE_RADIUS + (CURVE_EDGE_RADIUS / 4), 0);
        mAFirstCurveControlPoint2.set(mAFirstCurveEndPoint.x - (CURVE_EDGE_RADIUS * 2) + CURVE_EDGE_RADIUS, mAFirstCurveEndPoint.y);
        mAFirstCurveEndPoint.set(50, CURVE_EDGE_RADIUS + (CURVE_EDGE_RADIUS / 4));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPath.reset();
        mPath.moveTo(0, 0);
//        mPath.cubicTo(mAFirstCurveControlPoint1.x, mAFirstCurveControlPoint1.y,
//                mAFirstCurveControlPoint2.x, mAFirstCurveControlPoint2.y,
//                mAFirstCurveEndPoint.x, mAFirstCurveEndPoint.y);
